...
echo "<strong>In PHP, $ language['php'] is an example of</strong>";  echo "<font color='red'>&nbsp;&nbsp;&nbsp;$radio1Err</font>"; 
...
echo "<strong>In PHP, what is the next code for? if (isset ($ variable))</strong>";  echo "<font color='red'>&nbsp;&nbsp;&nbsp;$radio2Err</font>"; 
...
echo "<strong>What does PHP mean?</strong>";  echo "<font color='red'>&nbsp;&nbsp;&nbsp;$radio3Err</font>"; 
...
echo "<strong>In PHP, all the variables start with the symbol</strong>";  echo "<font color='red'>&nbsp;&nbsp;&nbsp;$radio4Err</font>"; 
